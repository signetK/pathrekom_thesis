...
![Grade Input Page](sample_ui/Final_UI/GradeInputPage.png)

### 4. Recommendation Results
![Results Page](sample_ui/Final_UI/ResultsPage(S1).png)

### 5. About Us
![About Us Page](sample_ui/Final_UI/AboutUsPage.png)
